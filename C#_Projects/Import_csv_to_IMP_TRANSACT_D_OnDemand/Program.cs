       ...
       static void Main(string[] args)
        {
           ...
           sqConTransactB.IntegratedSecurity = true;
            ...
            transactEmpty.CommandText = "Delete from [abc096].[IMP_TRANSACT_D]  Delete from [abc096].[IMP_TRANSACT_D_onDemand] ";
            transactEmpty.ExecuteNonQuery();

            Console.WriteLine("Transact tables cleared. \r\n");
            
            SqlCommand transactInsert = new SqlCommand();
            transactInsert.Connection = transactConn;
            transactInsert.CommandTimeout = 0;
            transactInsert.CommandText = "BULK INSERT  [abc096].[IMP_TRANSACT_D_onDemand] " +
            ...
            SqlCommand transactIns_D = new SqlCommand();
            transactIns_D.Connection = transactConn;
            transactIns_D.CommandTimeout = 0;
            transactIns_D.CommandText = "INSERT INTO [abc096].[IMP_TRANSACT_D]"+
"           ([TBL]                    "+
"           ,[TCODE]                  "+
"           ,[MID]                    "+
"           ,[TID]                    "+
...
"           ,[DCCCHOSEN_DCCELIGIBLE]  " +
"           ,[REDAMOUNT]              " +
"		   from [abc096].[IMP_TRANSACT_D_onDemand] ";
            transactIns_D.ExecuteNonQuery();

            Console.WriteLine("Data inserted to D table from onDemand table. \r\n");
