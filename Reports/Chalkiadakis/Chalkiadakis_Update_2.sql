...
and a.PROCESSED = 'ALPHA' and a.Brand = 'VISA'
...
--shop like ('%KALOKAIRI%') and 
a.Κατηγορία= 'Εντός Πακέτου' 
and a.PROCESSED = 'ALPHA' and a.Brand = 'MASTER'
 --and a.PROCESSED = 'ALPHA'
GROUP BY v.STORE_CODE, a.Shop, a.Brand,a.PROCESSED,v.COMMISION
--order by PROCESSED
) b
...
--shop like ('%KALOKAIRI%') and 
a.Κατηγορία= 'Εντός Πακέτου' 
and a.PROCESSED = 'ALPHA' and a.Brand = 'MAESTRO'
 --and a.PROCESSED = 'ALPHA'
GROUP BY v.STORE_CODE, a.Shop, a.Brand,a.PROCESSED,v.COMMISION
--order by PROCESSED
) b
...
--shop like ('%KALOKAIRI%') and 
a.Κατηγορία= 'Εντός Πακέτου' 
and a.PROCESSED = 'ALPHA' and a.Brand = 'AMEX'
 --and a.PROCESSED = 'ALPHA'
GROUP BY v.STORE_CODE, a.Shop, a.Brand,a.PROCESSED,v.COMMISION
--order by PROCESSED
) b
...
--shop like ('%KALOKAIRI%') and 
a.Κατηγορία= 'Εντός Πακέτου' 
and a.PROCESSED = 'ALPHA' and a.Brand = 'DINERS'
 --and a.PROCESSED = 'ALPHA'
GROUP BY v.STORE_CODE, a.Shop, a.Brand,a.PROCESSED,v.COMMISION
--order by PROCESSED
) b
...
--shop like ('%KALOKAIRI%') and 
a.Κατηγορία= 'Εντός Πακέτου' 
and a.PROCESSED = 'ALPHA' and a.Brand = 'CHINA UNION PAY'
 --and a.PROCESSED = 'ALPHA'
GROUP BY v.STORE_CODE, a.Shop, a.Brand,a.PROCESSED,v.COMMISION
--order by PROCESSED
) b
...
--shop like ('%KALOKAIRI%') and 
a.Κατηγορία= 'Εντός Πακέτου' 
and a.PROCESSED = 'ALPHA' and a.Brand = 'STORE'
 --and a.PROCESSED = 'ALPHA'
GROUP BY v.STORE_CODE, a.Shop, a.Brand,a.PROCESSED,v.COMMISION
--order by PROCESSED
) b
...
--shop like ('%KALOKAIRI%') and 
a.Κατηγορία= 'Εντός Πακέτου' 
and a.PROCESSED = 'ALPHA' and a.Brand not in ('MASTER','VISA','MAESTRO','CHINA UNION PAY','DINERS','STORE','AMEX')
 --and a.PROCESSED = 'ALPHA'
GROUP BY v.STORE_CODE, a.Shop, a.Brand,a.PROCESSED,v.COMMISION
--order by PROCESSED
) b
