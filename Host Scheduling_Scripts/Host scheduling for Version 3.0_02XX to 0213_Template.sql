...
SET @ToModel='Vx-520'
----**
SET @FromAppnm='EPOS0200P'
SET @ToAppnm='EPOS0213P'
SET @FromAppnm1='EPOS0200'
SET @ToAppnm1='EPOS0213'
--
-- -------- version 2.0
...
--
Print 'Update USES'
update vc30.PARAMETER set value = 'TEPOS0213P' where parnameloc = 'USES' and partid in
('01514349','01514348')
