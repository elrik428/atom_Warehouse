...
4.
--select * from merchbins where tid in (select tid from merchants where mid = '000000120005200') /*and binlower = '549804'*/
--select * from merchbins where tid = '73005513' order by destport,binlower --- Use as reference for check

5.
--delete from merchbins where tid in (select tid from merchants where mid = '000000120005200')
----select * from merchbins where tid = '1111    ' and destport = 'NET_NTBN' order by destport,binlower

6.  ---Check Banks
select distinct mid,tid,merchtitle,merchaddress from merchants where mid = '000000120005200' and tid not in
(select tid from merchants where mid = '000000120005200' and uploadhostid = 202)

select distinct mid,tid,merchtitle,merchaddress from merchants where mid = '000000120005200' and tid not in
(select tid from merchants where mid = '000000120005200' and uploadhostid = 205)

select distinct mid,tid,merchtitle,merchaddress from merchants where mid = '000000120005200' and tid not in
(select tid from merchants where mid = '000000120005200' and uploadhostid = 6)

select distinct mid,tid,merchtitle,merchaddress from merchants where mid = '000000120005200' and tid not in
(select tid from merchants where mid = '000000120005200' and uploadhostid = 1)
...
7.1 ---Basic Insert - Change from CUP so to run --
  ...
  --where TID = '1111    ' and DESTPORT = 'NET_CLBICALPHA'
...
------------
-- find maxinst
select * from merchbins where tid  in (select tid from merchants where mid = ('000000120005200'))
--8.
-- maxinst = 1
select gmaxinst, * from merchants where mid = ('000000120005200')
update merchants set gmaxinst=1  where mid = ('000000120005200')
------------
---------------------------------------------------------------------
select * from merchbins where tid in (select tid from merchants where mid = '000000120005200') and tid ='73000228'
---------------------------------------------------------------------
...
--9.
-------------------------------------
--delete loadbalance where balancegroup in (select 'M'+tid from merchants where mid = '000000120005200')
--and destport = 'NET_GENIKI'
select * from loadbalance where balancegroup in (select 'M'+tid from merchants where mid = '000000120005200')
and balancegroup ='M73000243'
order by balancegroup, DESTPORT
update loadbalance set LOADVALUE = 250000 where balancegroup in (select 'M'+tid from merchants where mid = '000000120005200') and destport = 'NET_NTBN'
update loadbalance set LOADVALUE = 1 where balancegroup in (select 'M'+tid from merchants where mid = '000000120005200') and destport = 'NET_ABC'
update loadbalance set LOADVALUE = 1 where balancegroup in (select 'M'+tid from merchants where mid = '000000120005200') and destport = 'NET_CLBICALPHA'
update loadbalance set LOADVALUE = 750000 where balancegroup in (select 'M'+tid from merchants where mid = '000000120005200') and destport = 'NET_CLBICEBNK'
-------------------------------------
--10.
declare @TID varchar(16), @BALGROUP varchar(20)

DECLARE merch_cursor CURSOR FOR
SELECT distinct(tid) FROM merchants WHERE mid = '000000120005200'
