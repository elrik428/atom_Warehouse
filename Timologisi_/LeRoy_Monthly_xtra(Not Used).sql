...
FROM (abc096.TIDs LEFT JOIN [ZacReporting].[abc096].[IMP_TRANSACT_D_2017] ON abc096.TIDs.TID=[ZacReporting].[abc096].[IMP_TRANSACT_D_2017].TID)
LEFT JOIN abc096.MIDs ON [ZacReporting].[abc096].[IMP_TRANSACT_D_2017].MID=abc096.MIDs.MID
