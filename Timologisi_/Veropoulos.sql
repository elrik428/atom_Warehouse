...
update  a
  ...
  from [abc096].[VER_Transactions_Month] as a
  inner join zacreporting.abc096.products_old_old b on substring(a.mask,1,6) = b.BIN /*and b.BANKID <>0*/
  where [ISSUER_BANK_ID]= 0  or  [ISSUER_BANK_ID] is null
;
...
print '--Update Issuer id - 2';
  ...
  set a.[ISSUER_BANK_ID] = b.bankid
  from [abc096].[VER_Transactions_Month] as a
  inner join zacreporting.abc096.products_old_old b on substring(a.mask,1,5) = b.BIN and b.BANKID <>0
  where [ISSUER_BANK_ID]= 0  or  [ISSUER_BANK_ID] is null
;
...
print '--Update Issuer id - 3';
  ...
  set a.[ISSUER_BANK_ID] = b.bankid
  from [abc096].[VER_Transactions_Month] as a
  inner join zacreporting.abc096.products_old_old b on substring(a.mask,1,4) = b.BIN and b.BANKID <>0
  where [ISSUER_BANK_ID]= 0  or  [ISSUER_BANK_ID] is null
;
...
print '--Update Issuer id - 4';
  ...
  set a.[ISSUER_BANK_ID] = b.bankid
  from [abc096].[VER_Transactions_Month] as a
  inner join zacreporting.abc096.products_old_old b on substring(a.mask,1,3) = b.BIN and b.BANKID <>0
  where [ISSUER_BANK_ID]= 0  or  [ISSUER_BANK_ID] is null
;
