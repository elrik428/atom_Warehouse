...
[ΔΙΑΚΡΙΤΙΚΟΣ ΤΙΤΛΟΣ] = (select distinct value from vc30.PARAMETER b where PARTID=termid and PARNAMELOC='RECEIPT_LINE_1' and substring(appnm,1,4) = ('PIRA') and substring(appnm,9,1) = ('P') and substring(PARTID,1,1) < '5' and famnm = vc30.relation.famnm ),
[ΔΙΕΥΘΥΝΣΗ] = (select distinct value from vc30.PARAMETER b where PARTID=termid and PARNAMELOC='RECEIPT_LINE_2' and substring(appnm,1,4) = ('PIRA') and substring(appnm,9,1) = ('P') and substring(PARTID,1,1) < '5' and famnm = vc30.relation.famnm ),
[ΠΟΛΗ] = (select distinct value from vc30.PARAMETER b where PARTID=termid and PARNAMELOC='RECEIPT_LINE_3' and substring(appnm,1,4) = ('PIRA') and substring(appnm,9,1) = ('P') and substring(PARTID,1,1) < '5' and famnm = vc30.relation.famnm ),
[ΤΗΛΕΦΩΝΟ] = (select distinct value from vc30.PARAMETER b where PARTID=termid and PARNAMELOC='RECEIPT_LINE_4' and substring(appnm,1,4) = ('PIRA') and substring(appnm,9,1) = ('P') and substring(PARTID,1,1) < '5' and famnm = vc30.relation.famnm ),
