...
--'TERMID_NCC','TERMID_HOST','MERCHID','RECEIPT_LINE_1','RECEIPT_LINE_2','RECEIPT_LINE_3','RECEIPT_LINE_4','DCCCAPABLE','DLL_CONN','SMARTPAD'
...
--'ETH.IPADDR','ETH.SUBNET','ETH.GATEWAY','HOST_IP','HOST_IP2','TMS_IP','BONUS_IP','BONUS_IP2'
--'MERCHID','LOYALTY_EUROBANK','LOYALTY_EUROBANK_ELS','LOYALTY_CITIBANK','LOYALTY_BONUS','LOYALTY_NBG','LIFECARD_LTY','LOYALTY_PBG'
--'SMARTPAD','DCCCAPABLE'
'MERCHID','HOST_IP','HOST_IP2','MEDIA','ETH.DHCP','TRANS_INIT','DLL_CONN','CONFIG_APN','MANUALENTRY','LOYALTY_BONUS','LOYALTY_NBG','LOYALTY_EUROBANK','LOYALTY_EUROBANK_ELS','LOYALTY_PBG'
,'GPRS_PORT'
,'BONUS_GPRS_PORT'
,'ETH_PORT'
,'BONUS_ETH_PORT')
